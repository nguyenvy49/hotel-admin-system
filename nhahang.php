      ...
      <div class="booking-item date-input">
        ...
        <section class="restaurant-hero-section">
            <div class="hero-image-wrapper">
                ...
                <img src="nhahang.jpg" alt="Dining area with pool view and natural light">
            </div>
        </section>
        ...
        <section class="gallery-content-section">
            <div class="content-row row-1">
                <div class="image-wrapper image-left">
                    <!-- Ảnh Tiệc cưới -->
                    <img src="cuoi.jpg" alt="Organize a romantic and cozy wedding">
                </div>
            ...
            <div class="content-row row-2">
                ...
                <div class="image-wrapper image-right">
                    <!-- Ảnh Hẹn hò lãng mạn -->
                    <img src="cauhon.jpg" alt="Romantic date nights">
                </div>
            </div>
            ...
            <div class="content-row row-3">
                <div class="image-wrapper image-left">
                    <!-- Ảnh Cooking Class -->
                    <img src="cook.jpg" alt="Cooking class">
                </div>
                <div class="text-wrapper text-right">
                    <p>Cooking class</p>
                </div>
        ...
        <section class="menu-highlight-section">
            ...
            <div class="dish-gallery">
                <div class="dish-item">
                    <!-- Gan Ngỗng Áp Chảo -->
                    <img src="ngan.jpg" alt="Foie Gras and Fig Jam">
                </div>
                <div class="dish-item">
                    <!-- Thăn Bò Rossini -->
                    <img src="bo.jpg" alt="Beef Tenderloin Rossini">
                </div>
                <div class="dish-item">
                    <!-- Bánh Dung Nham Sô-cô-la -->
                    <img src="scl.jpg" alt="Chocolate Lava Cake and Vanilla Ice Cream">
                </div>
            </div>
        </section>
